                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              课程列表<a class="btn btn-success mod" data-action="add" href="courses-add.asp">新建课程</a>
                          </header>
...
<th width="80" ><strong>课时表</strong></td>
          ...
          <tr > 
            ...
            <th ><a href="schedule.asp?ID=<%=rs("id")%>" class="btn btn-success btn-xs">编辑课时表</a></td>

            <td > 
              <a href="courses-mod.asp?ID=<%=rs("id")%>" class="btn btn-success btn-xs">修改</a> 
...
if action="Del" then
conn.execute "delete from [courses] where Id="&Trim(delid)
response.Redirect("courses.Asp?sta=del")
end if
%>
