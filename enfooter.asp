<div class="footer1">
    <div class="container">
    <div class="row">
    <ul class="stools"><a href="#" class="col-md-3"><i class="stico stico1 tra"></i><p class="tit">Live Chat</p><p class="txt">A Chat Assistant is available to help. Click here to start the session</p></a>
    <a href="tel:400-033-9909" class="col-md-3"><i class="stico stico2 tra"></i><p class="tit">Hotline</p><p class="txt"><em class="fz21p">400-033-9909</em><br>9:00 am - 6:00 pm on weekdays</p></a>
    <a href="mailto:info@hitpointcloud.com" class="col-md-3"><i class="stico stico3 tra"></i><p class="tit">Email</p><p class="txt">info@hitpointcloud.com<br></p></a>
    <a href="getdemo.asp" class="col-md-3"><i class="stico stico4 tra"></i><p class="tit">DEMO</p><p class="txt">Fill in a quick form for free demo<br></p></a></ul>
</div>
</div>
</div>
...
<ul class="fmenu">
    ...
    <a href="enproductsDetail.asp?pid=68&bid=37">Oracle</a><br>
     <a href="enproductsDetail.asp?pid=69&bid=39">NetDimensions</a>
</ul>
<ul class="fmenu">
...
<li><i class="fcico fcaddress"></i>East Guoding Road 200, Yangpu District,<br>Shanghai, P.R.China,200433</li>
</ul>
<div class="fsns">
